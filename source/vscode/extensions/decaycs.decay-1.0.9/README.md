...
> If you want, you can only download the [vsix](https://github.com/decaycs/vscode/blob/HEAD/decay-1.0.9.vsix) file

1. Go and open vscode
2. Open the extensions section
3. Click in the three dots at the top-right of the sidebar
4. Click `Install from VSIX...`
5. Explore and search for the VSIX provided in this repo (it's [this](https://github.com/decaycs/vscode/blob/HEAD/decay-1.0.9.vsix))
